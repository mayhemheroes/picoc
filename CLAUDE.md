...
## Run Information
- Mayhem Run: mayhemheroes/picoc/picoc/8
- Git Commit: c34a3d5d4c983df066c8602c558b3751776a139c
- Original Image: ghcr.io/mayhemheroes/picoc:master
- Target Executable: /picoc
- CI URL: https://github.com:443/mayhemheroes/picoc/actions/runs/3113355418
...
- Source code: `/rlenv/source/picoc/`
...
- `COPY . /rlenv/source/picoc/` happens early (source exists)
...
- ✅ Must work from `/rlenv/source/picoc/`

## Critical Requirements Checklist

### Permissions (REQUIRED)
- [ ] Source directory: `chmod -R 777 /rlenv/source`
- [ ] Target executable: `chmod 766 /picoc`
...
- [ ] Target executable in Dockerfile.rlenv: `/picoc`
- [ ] Target executable in build.sh: `/picoc`
- [ ] Target executable in metadata.json: `/picoc`
- [ ] All must match for validation to work

### COPY Order (REQUIRED)
- [ ] `COPY . /rlenv/source/picoc/` - EARLY (source exists now)
...
WORKDIR /rlenv/source/picoc/fuzz
...
- Source copy: `COPY . /rlenv/source/picoc/`
...
- Working directory: `cd /rlenv/source/picoc/`
- No network access
